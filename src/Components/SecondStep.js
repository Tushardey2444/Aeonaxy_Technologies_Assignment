   ...
   return(
    ...
    <div>
        ...
        <div className="flex flex-col h-full w-full items-center px-4 md:px-0">
            ...
            <div className="h-40 w-40 rounded-full border-dashed border-2 border-zinc-300 flex justify-center items-center">
                <BiSolidCameraPlus  className="text-gray-400 w-7 h-7"/>
            </div>
